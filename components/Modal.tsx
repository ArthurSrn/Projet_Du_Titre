  ...
  return (
    <>
      <div
        ...
        "
      >
        <div className="relative lg:w-3/6 my-6  lg:max-w-3xl lg:h-auto pt-[100px] pb-[100px] px-6">
          {/*content*/}
          <div className="
            h-full
            lg:h-auto
          ...
          >
            ...
            <div className="
              ...
              "
            >
              <h3 className="text-3xl font-semibold text-bl">
                {title}
              </h3>
              <button
                className="
            ...
            {/*body*/}
            <div className="relative px-8 pt-3 md:p-10 flex-auto">
              {body}
            </div>
            {/*footer*/}
